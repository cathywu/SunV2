/******************************************************************************
 * Software UART example for MSP430 with ability disable and re-enable.
 *
 * @author cathywu
 *
 * Adapted from: Stefan Wendler
 * Original code from Nicholas J. Conn [http://www.msp430launchpad.com/2010/08/half-duplex-software-uart-on-launchpad.html]
